...
if($this->context->action->id=='favorites')
    $searchFormAction = ['/'.$this->context->route];
...
if($searchModel->category){
    ...
    $searchFormAction['category_title_url'] = $searchModel->category->title_url;
}
?>
    ...
    if($request->get('q') && Helper::cleanForMatchAgainst($request->get('q'))){
        ...
        if($categories){
            ...
            <div class="categoriesBlock">
                <label><?=Yii::t('category', 'Categories')?></label>
                <ul>
                    <?php
                    foreach ($categories as $category) {
                        ?>
                        <li><?=Html::a($category->title."($category->product_count)", $category->url)?></li>
                        <?php
                    }
                    ?>
                </ul>
