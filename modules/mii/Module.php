...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'mii\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'mii\console\GenerateController',
    ...
    {
        return [
            'model' => ['class' => 'mii\generators\model\Generator'],
            'crud' => ['class' => 'mii\generators\crud\Generator'],
            'controller' => ['class' => 'mii\generators\controller\Generator'],
            'form' => ['class' => 'mii\generators\form\Generator'],
            'module' => ['class' => 'mii\generators\module\Generator'],
            'extension' => ['class' => 'mii\generators\extension\Generator'],
        ];
    }
}
