...
NavBar::begin([
    ...
    'options' => [
        'class' => 'navbar navbar-default navbar-menu',
    ],
]);
echo Nav::widget([
    'encodeLabels'=>false,
...
?>
<nav id="category-menu" class="nav-gray-category" style="display: none;" >
    <?php
    $this->registerJs("
...
<div class="navbar navbar-default navbar-menu navbar-menu-hidden">
    <div class="container">
